...
function doImport(){var a=$("#importTextBox").val();a=/--CATS--\n([\s\S]*)\n--REWRITE--\n([\s\S]*)\n--MONO--\n([\s\S]*)\n--MID--\n([\s\S]*)\n--INIT--\n([\s\S]*)\n--FINAL--\n([\s\S]*)\n--FLAGS--\n([01]) ([01]) ([^ ]+) ([^ ]+)(\n--ADVANCED--\n([0-9]+)\n([0-9]+)\n([0-9]+)\n([0-9]+)\n([^\n]+))?/.exec(a);var b;if(null===a)return alert("Incorrect format.");$("#cats").val(a[1]);$("#rewrite").val(a[2]);$("#sing").val(a[3]);$("#syls").val(a[4]);$("#wrdi").val(a[5]);$("#wrdf").val(a[6]);$("#onetype").prop("checked",
