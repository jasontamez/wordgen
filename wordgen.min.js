...
var j={c:null,m:null,i:null,f:null,w:null,r:null,p:{c:null,m:null,i:null,f:null,w:null,r:null},s:!1,u:!1,z:!1,g:new XMLHttpRequest,n:"/predefs.txt",d:new Map,a:String.fromCharCode(160),o:30,e:20,l:!1,h:!1,t:!0};function $i(e,t=document){return t.getElementById(e)}function $q(e,t=document){return t.querySelector(e)}function $a(e,t=document){return t.querySelectorAll(e)}function $e(e,t=!1,o=!1){var r=document.createElement(e);return!1!==t&&(r.textContent=t),!1!==o&&Object.entries(o).forEach(e=>r.setAttribute(e[0],e[1])),r}function $t(e){return document.createTextNode(e)}function $f(){return document.createDocumentFragment()}function escapeHTML(e){return $e("p",e).innerHTML}function parseSyllables(e){var t=[];return e.split(/\r?\n/).forEach(function(e){var o=e.trim();""!==o&&t.push(o)}),t}function handleCategoriesInRewriteRule(e){for(var t,o,r,n=e.split("%%"),a=[],i=j.c;n.length;){for(o=(t=n.shift().split("!%")).shift();t.length;){let e;r=t.shift(),e=i.get(r.charAt(0)),void 0!==test&&(o+="[^"+e+"]"),o+=r.substring(1)}for(t=o.split("%"),o=t.shift();t.length;){let e;r=t.shift(),void 0!==(e=i.get(r.charAt(0)))&&(o+="["+e+"]"),o+=r.substring(1)}a.push(o)}return a.join("%")}function applyRewriteRules(e){return j.r.forEach(function(t,o){e=e.replace(o,t)}),e}function getRandomPercentage(){return Math.floor(101*Math.random())}function powerLaw(e,t){var o;for(o=0;;o=(o+1)%e)if(getRandomPercentage()<t)return o}function peakedPowerLaw(e,t,o){return Math.random()>.5?t+powerLaw(e-t,o):t-powerLaw(t+1,o)}
function oneSyllable(e,t){var o,r,n,a,i=syllPatternPick(t),l=j.c,s=j.o;for(o=0;o<i.length;o++)a=i.charAt(o),void 0===(r=l.get(a))?e+=a:(n=0===s?Math.random()*r.length:powerLaw(r.length,s),e+=r.charAt(n));return e}function syllPatternPick(e){var t,o;switch(e){case-1:o=j.i;break;case 0:o=j.m;break;case 1:o=j.f;break;case 2:o=j.w}return o[powerLaw(t=o.length,calcDropoff(t))]}function getOneWord(e){var t,o,r=1,n=j.e,a=j.t,i="";if(101*Math.random()>=n&&(r+=1+powerLaw(4,50)),1===r)i=oneSyllable("",a?-1:2);else{let e=j.h;for(t=1;t<=r;t++)a||1===t?o=-1:t>1&&(o=t<r?0:1),i=oneSyllable(i,o),e&&t<r&&(i+="·")}return i=applyRewriteRules(i),e&&(i=i.charAt(0).toUpperCase()+i.substring(1)),i}function createText(){var e,t,o,r="",n=getAdvancedNumber($i("sentences"),30,500);for(e=0;e<n;e++)for(o=peakedPowerLaw(15,5,50),t=0;t<=o;t++)r+=getOneWord(0===t),t===o&&(r+=".....?!".charAt(Math.floor(7*Math.random()))),r+=" ";return $t(r)}function createLex(e){var t,o=$e("div"),r=getAdvancedNumber($i("lexiconLength"),150,1e3),n=[];for(o.classList.add("lexicon"),o.style.gridTemplateColumns="repeat(auto-fit, minmax("+getAdvancedNumber($i("wordLengthInEms"),10,1e3).toString()+"em, 1fr) )",t=0;t<r;t++)n.push(getOneWord(e));return n.sort(),n.forEach(function(e){o.appendChild($e("div",e))}),o}function createLongLex(){var e,t=$f(),o=getAdvancedNumber($i("largeLexiconLength"),750,5e3);for(e=0;e<o;e++)t.append(getOneWord(!1),$e("br"));return t}function getAdvancedNumber(e,t,o){var r=parseInt(e.value);return isNaN(r)||r<1?t:r>o?o:r}
function getEverySyllable(){var e,t=new Set,o=$f();return new Set(j.m.concat(j.i,j.f,j.w)).forEach(function(e){recurseCategoriesForSyllables(t,"",e.split(""))}),(e=[...t]).sort(),o.appendChild($t(e.shift())),e.forEach(e=>o.append($e("br"),e)),o}function recurseCategoriesForSyllables(e,t,o){var r,n=o.slice(0);void 0===(r=j.c.get(n.shift()))?(t+=r,n.length?recurseCategoriesForSyllables(e,t,n):e.add(applyRewriteRules(t))):n.length>0?r.split("").forEach(function(o){recurseCategoriesForSyllables(e,t+o,n)}):r.split("").forEach(function(o){e.add(applyRewriteRules(t+o))})}
function generate(){var e,t,o,r,n,a,i,l,s=[],u=j.c;if(e=$q("input[type=radio][name=outType]:checked").value,j.h=$i("showSyls").checked,j.l=$i("slowSylDrop").checked,a=$i("oneType").checked,j.t=a,i=Number($q("input[type=radio][name=monoRate]:checked").value),l=Number($q("input[type=radio][name=dropoff]:checked").value),(i=Math.min(Math.max(i,0),100))!=i&&(i=100),j.e=i,(l=Math.min(Math.max(l,0),45))!=l&&(l=45),j.o=l,(t=$i("categories").value)!==j.p.c){let e=parseCategories(t);e.flag&&e.cats.size>0?(j.p.c=t,j.c=e.cats,u=e.cats):(s.push(...e.msgs),u=!1)}if((t=$i("midWord").value)!==j.p.m&&(j.m=parseSyllables(t),j.p.m=t),(t=$i("wordInitial").value)!==j.p.i&&(j.i=parseSyllables(t),j.p.i=t),(t=$i("wordFinal").value)!==j.p.f&&(j.f=parseSyllables(t),j.p.f=t),(t=$i("singleWord").value)!==j.p.w&&(j.w=parseSyllables(t),j.p.w=t),!u||u.size<=0)(r=$f()).append($e("strong","Missing:"),j.a+"You must have categories to generate text."),s.push(r);else if(u&&(t=$i("rewrite").value,o=$i("rewSep").value,j.p.r!==t||o!==j.s)){let e;j.s=o,(e=parseRewriteRules(t)).flag?(j.p.r=t,j.r=e.rules):s.push(...e.msgs)}if(a&&j.i.length<=0?((r=$f()).append($e("strong","Missing:"),j.a+"You must have syllable types to generate text."),s.push(r)):!a&&(j.m.length<=0||j.i.length<=0||j.f.length<=0||j.w.length<=0)&&((r=$f()).append($e("strong","Missing:"),j.a+"You must have"+j.a,$e("em","all"),j.a+"syllable types to generate text."),s.push(r)),s.length>0)(n=$f()).appendChild(s.shift()),s.forEach(function(e){n.append($e("br"),$e("br"),e)});else switch(e){case"text":n=createText();break;case"dict":n=createLex(!1);break;case"dictC":n=createLex(!0);break;case"longdict":n=createLongLex();break;case"genall":n=getEverySyllable()}eraseOutputFromScreen(),$i("outputText").appendChild(n)}
function parseCategories(e){var t=e.split(/\r?\n/),o=new Map,r=[];return{flag:t.every(function(e){var t=e.trim();const n=t.length;if(0===n);else{if(n<3||1!==t.indexOf("=")||-1!==t.indexOf("=",2)){let e=$f();return e.append($e("strong","Error:"),j.a+t,$e("br"),"Categories must be of the form V=aeiou",$e("br"),"That is, a single letter, an equal sign, then a list of possible expansions."),r.push(e),!1}{let e=t.charAt(0);if(void 0!==o.get(e)){let e=$f();return e.append($e("strong","Error:"),j.a+"You have defined category "+t+" more than once."),r.push(e),!1}o.set(e,t.substring(2))}}return!0}),cats:o,msgs:r}}function parseRewriteRules(e){var t=e.split(/\r?\n/),o=new Map,r=[],n=j.s;return{flag:t.every(function(e){var t=e.indexOf(n);if(""===e.trim());else{if(t<1||t!==e.lastIndexOf(n)){let t=$f();return t.append($e("strong","Error:"),j.a+e,$e("br"),"Rewrite rules must be in the form x"+n+"y",$e("br"),"That is, a rule (x), followed by "+("||"===n?"two vertical bars":'the exact text "'+n+'"')+", followed by a replacement expression (y, which may be blank)."),r.push(t),!1}{let r=e.substring(t+2),n=new RegExp(handleCategoriesInRewriteRule(e.substring(0,t)),"g");o.set(n,r)}}return!0}),rules:o,msgs:r}}function calcDropoff(e){if(1===e)return 101;if(j.l)switch(e){case 2:return 50;case 3:return 40;case 4:case 5:case 6:case 7:case 8:case 9:return 46-4*e;default:return 9}return e<9?60-5*e:12}function eraseOutputFromScreen(){for(var e=$i("outputText");e.firstChild;)e.removeChild(e.firstChild)}
...
function saveCustom(e){var t=$i("predef");if(j.z){if(j.u&&!0!==e)return doConfirm("Warning!","You already have information saved. Do you want to overwrite it?",function(){saveCustom(!0)},function(){doAlert("Previous information saved.","Nothing overwritten.","success")},"warning","Yes","No");if(localStorage.setItem("CustomCategories",$i("categories").value),localStorage.setItem("CustomRewrite",$i("rewrite").value),localStorage.setItem("CustomSingleWord",$i("singleWord").value),localStorage.setItem("CustomMidWord",$i("midWord").value),localStorage.setItem("CustomInitial",$i("wordInitial").value),localStorage.setItem("CustomFinal",$i("wordFinal").value),localStorage.setItem("CustomOneType",$i("oneType").checked),localStorage.setItem("CustomSlowSylDrop",$i("slowSylDrop").checked),localStorage.setItem("CustomMono",$q("input[name=monoRate]:checked").getAttribute("id")),localStorage.setItem("CustomDropoff",$q("input[name=dropoff]:checked").getAttribute("id")),localStorage.setItem("CustomWordLengthInEms",$i("wordLengthInEms").value),localStorage.setItem("CustomLexiconLength",$i("lexiconLength").value),localStorage.setItem("CustomLargeLexiconLength",$i("largeLexiconLength").value),localStorage.setItem("CustomSentences",$i("sentences").value),localStorage.setItem("CustomRewSep",$i("rewSep").value),j.u=!0,null==$q('option[value="pd-1"]',t)){let e=document.createElement("option");e.value="pd-1",e.textContent="Custom",t.prepend(e)}t.value="pd-1",j.d.set("pd-1",doExport(!1)),doAlert("Saved to browser.","","success")}else doAlert("","Your browser does not support Local Storage and cannot save your information.","error")}
function clearCustom(e){if(j.z)if(j.u){if(j.u&&!0!==e)return doConfirm("Warning!","Are you sure you want to delete your saved settings?",function(){clearCustom(!0)},function(){doAlert("Settings kept.","","success")},"warning","Yes","No");["CustomCategories","CustomRewrite","CustomSingleWord","CustomMidWord","CustomInitial","CustomFinal","CustomOneType","CustomSlowSylDrop","CustomMono","CustomDropoff","CustomWordLengthInEms","CustomLexiconLength","CustomLargeLexiconLength","CustomSentences","CustomRewSep"].forEach(function(e){window.localStorage.removeItem(e)}),j.u=!1,$q('#predef option[value="-1"]').remove(),j.d.delete("pd-1"),doAlert("Cleared from browser.","","success")}else doAlert("","You don't have anything saved.","error");else doAlert("Sorry!","Your browser does not support Local Storage and cannot save your information.","error")}function showIPA(){eraseOutputFromScreen(),$i("outputText").appendChild(createIPASymbolsFragment([$e("br"),$e("br")]))}function advancedOptions(){$i("advancedOpen").classList.toggle("closed")}function loadPredef(){var e=$i("predef").value;console.log("Opening predef ["+e+"]"),doImport(j.d.get(e),!1,!1),syllabicChangeDetection()}function parseResult(){var e=j.g.responseText.trim().split(/\n--END--/),t=j.d.size+(void 0===j.d.get("pd-1")?0:-1);e.forEach(function(e){var o=e.trim().match(/^([^\r\n]+)\r?\n/);if(null===o)console.log("Unable to parse predef name: "+e);else{let r=o[0].trim(),n=e.slice(o[0].length).replace(/\r/g,"").trim();if(console.log("Testing predef: "+r),doImport(n,!0)){let e=$i("predef"),o=document.createElement("option"),a="pd";console.log("Saving predef: "+r),a+=(++t).toString(),j.d.set(a,n),o.textContent=r,o.value=a,e.appendChild(o)}else console.log(n.replace(/\n/g,"\\n"))}}),$i("loadPredefButton").disabled=!1,$i("predef").disabled=!1}
function syllabicChangeDetection(){$i("oneType").checked?($a("#p_multi,.multiswap").forEach(e=>e.classList.add("hidden")),$a(".singleswap").forEach(e=>e.classList.remove("hidden"))):($a("#p_multi,.multiswap").forEach(e=>e.classList.remove("hidden")),$a(".singleswap").forEach(e=>e.classList.add("hidden")))}if(j.g.addEventListener("load",parseResult),j.g.open("GET",j.n),j.g.send(),$i("loadPredefButton").disabled=!0,$i("predef").disabled=!0,j.d.set("pd1",doExport(null)),"undefined"!=typeof Storage){if(j.z=!0,null!==localStorage.getItem("CustomCategories")){j.u=!0;let e=document.createElement("option"),t=[localStorage.getItem("CustomMono"),localStorage.getItem("CustomDropoff")],o=[];$i("categories").value=localStorage.getItem("CustomCategories"),$i("rewrite").value=localStorage.getItem("CustomRewrite"),$i("singleWord").value=localStorage.getItem("CustomSingleWord"),$i("midWord").value=localStorage.getItem("CustomMidWord"),$i("wordInitial").value=localStorage.getItem("CustomInitial"),$i("wordFinal").value=localStorage.getItem("CustomFinal"),"true"===localStorage.getItem("CustomOneType")?t.push("oneType"):o.push("oneType"),"true"===localStorage.getItem("CustomSlowSylDrop")?t.push("slowSylDrop"):o.push("slowSylDrop"),t.forEach(e=>$i(e).checked=!0),o.forEach(e=>$i(e).checked=!1),j.d.set("pd-1",doExport(!1)),e.value="pd-1",e.textContent="Custom",$i("predef").prepend(e),$i("predef").value="pd-1"}syllabicChangeDetection()}
