...
$jscomp.arrayFromIterable=function(a){return a instanceof Array?a:$jscomp.arrayFromIterator($jscomp.makeIterator(a))};var categories,previousCat=!1,midWordSyls,wordInitSyls,wordFinalSyls,singleWordSyls,previousMidWordSyls=!1,previousWordInitSyls=!1,previousWordFinalSyls=!1,previousSingleWordSyls=!1,rew,nrew,previousRew=!1,rewSep=!1,CustomInfo=!1,Customizable=!1,getter=new XMLHttpRequest,predefFilename="/predefs.txt",predefs={},SPACE=String.fromCharCode(160);
function $i(a,b){b=void 0===b?document:b;return b.getElementById(a)}function $q(a,b){b=void 0===b?document:b;return b.querySelector(a)}function $a(a,b){b=void 0===b?document:b;return b.querySelectorAll(a)}function $e(a,b,c){b=void 0===b?!1:b;c=void 0===c?!1:c;var d=document.createElement(a);!1!==b&&(d.textContent=b);!1!==c&&Object.entries(c).forEach(function(a){return d.setAttribute(a[0],a[1])});return d}function $t(a){return document.createTextNode(a)}
function $f(){return document.createDocumentFragment()}function parseSyllables(a){var b=[];a.split(/\r?\n/).forEach(function(a){a=a.trim();""!==a&&b.push(a)});return b}
...
function createText(a,b,c,d,f){var h,g,e="",k=getAdvancedNumber($i("sentences"),30,500);for(h=0;h<k;h++){var l=peakedPowerLaw(15,5,50);for(g=0;g<=l;g++)e+=getOneWord(0===g,a,b,c,d,f),g===l&&(e+=".....?!".charAt(Math.floor(7*Math.random()))),e+=" "}return $t(e)}
function createLex(a,b,c,d,f,h){var g,e=$e("div"),k=getAdvancedNumber($i("lexiconLength"),150,1E3),l=[];e.classList.add("lexicon");e.style.gridTemplateColumns="repeat(auto-fit, minmax("+getAdvancedNumber($i("wordLengthInEms"),10,1E3).toString()+"em, 1fr) )";for(g=0;g<k;g++)l.push(getOneWord(a,b,c,d,f,h));l.sort();l.forEach(function(a){e.appendChild($e("div",a))});return e}
...
e=$i("rewrite").value;k=$i("rewSep").value;if(previousRew!==e||k!==rewSep)rewSep=k,k=parseRewriteRules(e),k.flag?(previousRew=e,nrew=k.len,rew=k.rules):a.push.apply(a,$jscomp.arrayFromIterable(k.msgs));0>=categories.length&&(e=$f(),e.append($e("strong","Missing:"),SPACE+"You must have categories to generate text."),a.push(e));f&&0>=wordInitSyls.length?(e=$f(),e.append($e("strong","Missing:"),SPACE+"You must have syllable types to generate text."),a.push(e)):!f&&(0>=midWordSyls.length||0>=wordInitSyls.length||
0>=wordFinalSyls.length||0>=singleWordSyls.length)&&(e=$f(),e.append($e("strong","Missing:"),SPACE+"You must have"+SPACE,$e("em","all"),SPACE+"syllable types to generate text."),a.push(e));if(0<a.length){var l=$f();l.appendChild(a.shift());a.forEach(function(a){l.append($e("br"),$e("br"),a)})}else switch(b){case "text":l=createText(h,f,c,g,d);break;case "dict":l=createLex(!1,h,f,c,g,d);break;case "dictC":l=createLex(!0,h,f,c,g,d);break;case "longdict":l=createLongLex(h,f,c,g,d);break;case "genall":l=
getEverySyllable()}erase();$i("outputText").appendChild(l)}
function parseCategories(a){a=a.split(/\r?\n/);var b={length:a.length,index:""},c=[];return{flag:a.every(function(a){a=a.trim();var d=a.length;if(0===d)b.length--;else{if(3>d||1!==a.indexOf("=")||-1!==a.indexOf("=",2))return d=$f(),d.append($e("strong","Error:"),SPACE+a,$e("br"),"Categories must be of the form V=aeiou",$e("br"),"That is, a single letter, an equal sign, then a list of possible expansions."),c.push(d),!1;d=a.charAt(0);if(b.hasOwnProperty(d))return d=$f(),d.append($e("strong","Error:"),
SPACE+"You have defined category "+a+" more than once."),c.push(d),!1;b.index+=d;b[d]=a.substring(2)}return!0}),cats:b,msgs:c}}
function parseRewriteRules(a){a=a.split(/\r?\n/);var b=a.length,c=0,d={},f=[];return{flag:a.every(function(a){var g=a.indexOf(rewSep);if(""===a.trim())b--;else{if(1>g||g!==a.lastIndexOf(rewSep)){var e=$f();e.append($e("strong","Error:"),SPACE+a,$e("br"),"Rewrite rules must be in the form x"+rewSep+"y",$e("br"),"That is, a rule (x), followed by "+("||"===rewSep?"two vertical bars":'the exact text "'+rewSep+'"')+", followed by a replacement expression (y, which may be blank).");f.push(e);return!1}e=
a.substring(g+2);a=new RegExp(handleCategoriesInRewriteRule(a.substring(0,g)),"g");d[c.toString()]=[a,e];c++}return!0}),rules:d,len:b,msgs:f}}function calcDropoff(a,b){if(1===a)return 101;if(b)switch(a){case 2:return 50;case 3:return 40;case 4:case 5:case 6:case 7:case 8:case 9:return 46-4*a;default:return 9}return 9>a?60-5*a:12}function erase(){for(var a=$i("outputText");a.firstChild;)a.removeChild(a.firstChild)}
